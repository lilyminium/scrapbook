...
def generate_conformers(rdmol: "rdkit.Chem.Mol",
    ...
    print(f"Generated {rdmol.GetNumConformers()} original conformers")
...
def generate_diverse_conformer_ids(rdmol,
                                    n_conformer_pool: int = 400,
                                    energy_window: float = 15,
                                    n_max_conformers: int = 10,
                                    rms_tolerance: float = 0.05,
                                    ):
    generate_conformers(rdmol, n_conformers=n_conformer_pool,
                        rms_tolerance=rms_tolerance)
    return select_elf_conformer_ids(rdmol,
...
def generate_diverse_conformer_coordinates(molecule,
    ...
    ids = generate_diverse_conformer_ids(molecule,
